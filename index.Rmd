...
rotation <- round(pca_interests$rotation[, 1:10], digits = 2)
kable(rotation)
...
<p class="text-warning">BASIC BIPLOT</p>
...
library(FactoMineR); library(knitr)

PCA_interests <- PCA(interests, graph = FALSE)

kable(PCA_interests$var$cos2, digits = 3)

fviz_pca_var(PCA_interests, col.var = "cos2") + scale_color_gradient2(low="white", mid="darkorchid4", high="red", midpoint=0.5) + theme_minimal()
