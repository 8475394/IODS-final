...
dim_interest <- dim(interests) # 878 observations and 32 variables
...
# Presenting correlation matrixes of the 3 groups
...
kable(cor_matrix2, format = "pandoc", digits = 2,  align="c")

cor_matrix3 <- cor(interests3) %>% round(digits = 2)
kable(cor_matrix3, format = "pandoc", digits = 2,  align="c")
```
