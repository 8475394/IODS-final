...
<p class="text-warning">CONTENTS OF ORIGINAL VS. FIRST TEST DATASET</p>
...
## PCA with the first testing dataset
...
<p class="text-warning">BIPLOT OF THE FIRST TEST DATASET</p>
...
<p class="text-warning">CONTENTS OF ORIGINAL VS. SECOND TEST DATASET</p>
...
## PCA with the second test dataset
...
<p class="text-warning">VARIABLE CONTRIBUTION WITH UNROTATED DATA</p>
...
<p class="text-warning">RC1, INTEREST TOWARD ARTISTIC AND THERAPEUTIC THEMES </p>
* Art Exhibitions
* Theatre
* Poetry Reading
* Poetry Writing 
* Psychology
* Read about [art and psychology](https://thepsychologist.bps.org.uk/volume-20/edition-2/personality-and-art)

<p class="text-warning">RC3, INTEREST TOWARD ORGANIC AND INORGANIC SCIENCES</p>
* Biology
* Chemistry
* Medicine

<p class="text-warning">RC2, INTEREST TOWARD TECHNICAL AND MATHEMATICAL PROPERTIES</p>
* PC
* Physics
* Mathematics
* Science and Technology
...
<p class="text-warning">RC5, INTEREST TOWARD SOCIETAL FACTORS</p>
* Politics
* Law
* History
* Geography
...
<p class="text-warning">RC4, INTEREST TOWARD HAVING FUN IN LEISURE TIME </p>
* Shopping
* Celebrity lifestyle
* Dancing
...
<p class="text-warning">GRAPH OF PRINCIPAL COMPONENT STRUCTURE</p>
...
<p class="text-warning">ANOTHER GRAPH OF PRINCIPAL COMPONENT STRUCTURE</p>
...
<p class="text-warning">RENAMING THE PC SCORES</p>
...
g = ggpairs(hobby, lower = list(continuous = wrap("smooth", color="palevioletred1")), upper = list(continuous = wrap("density", color = "blue")))
g
```
