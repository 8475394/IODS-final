...
Earlier part I had some troubles to reveal the dimensional structure of my data. 
...
kable(round(eig.val[1:10,], digits = 3), format = "pandoc", align="c", caption = "Eigenvalues and variances")
```
...
https://www.packtpub.com/books/content/dimensionality-reduction-principal-component-analysis
